...
declare module powerbi.extensibility.utils.chart.legend {
    ...
    class SVGLegend implements ILegend {
        ...
        constructor(element: JQuery, legendPosition: LegendPosition, interactivityService: IInteractivityService<SelectionDataPoint>, isScrollable: boolean, interactiveBehavior?: IInteractiveBehavior);
